...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center rounded-xl bg-white/5 p-1 text-slate-400 border border-white/8",
      className
    )}
    {...props}
  />
